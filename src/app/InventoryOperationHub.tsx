...
export default function InventoryOperationHub({ onNavigate }: Props) {
  return (
    <section className="panel" aria-label="庫存管理操作入口">
      ...
      <div className="summary-list">
        <div className="summary-row"><span><strong>期初庫存</strong><small>只在 PRE_CUTOVER 使用；透過耐久匯入預覽後一次發布。</small></span><button className="secondary-button" type="button" onClick={() => document.getElementById("inventory-opening-import")?.scrollIntoView({ behavior: "smooth", block: "start" })}>前往期初匯入</button></div>
