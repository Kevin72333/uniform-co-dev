...
| 實體 | 主鍵／唯一鍵 | 關鍵欄位與關係 |
|---|---|---|
| app_accounts | id uuid PK；auth_user_id uuid UNIQUE NULL | display_name、email_snapshot、is_active。id 是可還原且不可變的業務帳號識別；auth_user_id 只用來綁定目前 Supabase Auth 身分，不作任何業務 actor FK。 |
